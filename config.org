...
- [[#org-mode][ORG-MODE]]
  ...
  - [[#org-publish-functions][Org publish functions]]
  - [[#org-roam][org-roam]]
- [[#calendar][CALENDAR]]
...
#+RESULTS:
| d | default | plain | (file ~/.config/doom/templates/roam-templates/default-capture-entry.org) | :if-new | (file+head ${slug}.org (file ~/.config/doom/templates/roam-templates/default-caputre-file.org)) | :unnarrowed | t |
| t | tipjar  | plain | (file ~/.config/doom/templates/roam-tempmlates/tipjar-entry.org)         | :if-new | (file+head TipJar/${slug}.org (file ~/.config/doom/templates/roam-templates/tipjar-file.org))   | :unnarrowed | t |
