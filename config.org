...
- [[#modules][MODULES]]
  ...
  - [[#eva-personal-assistant][Eva Personal assistant]]
...
#+RESULTS:
| eva | :modules | ((:private . config) (:private . modules)) | :recipe | (:host github :repo meedstrom/eva :files (:defaults assets renv *.R *.gnuplot)) |
*** code
#+begin_src emacs-lisp
(use-package eva
  :init
